...
exports.SessionQueryEngine = void 0;
/**
...
class SessionQueryEngine {
     ...
     */
    async getInteractiveSessions(options = {}) {
     ...
     */
    async queryInteractiveSessionsRaw(database) {
        try {
        ...
        `);
            ...
            // Execute query
            const result = statement.get(SessionQueryEngine.INTERACTIVE_SESSIONS_KEY);
     ...
     */
    calculateSessionMetadata(sessions) {
...
SessionQueryEngine.INTERACTIVE_SESSIONS_KEY = 'interactive.sessions';
SessionQueryEngine.ITEM_TABLE = 'ItemTable';
//# sourceMappingURL=SessionQueryEngine.js.map